...
export default function AssociationHistory() {
  ...
  return (
    <section 
      ref={sectionRef}
      className={`relative w-full bg-black py-12 md:py-16 overflow-visible section-transition ${
        isVisible ? 'animate' : ''
      }`}
    >
            ...
            <div className={`absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 w-full max-w-md md:max-w-lg transition-all duration-1000 z-20 ${
              ...
              <div className="relative aspect-[4/3] overflow-hidden rounded-lg shadow-2xl border-4 border-white">
                ...
                <button
                  ...
                  className="absolute left-2 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white text-gray-800 p-2 rounded-full shadow-lg transition-all z-10 hover:scale-110"
                ...
                <button
                  onClick={goToNext}
                  className="absolute right-2 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white text-gray-800 p-2 rounded-full shadow-lg transition-all z-10 hover:scale-110"
