        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/reglamento" className="text-gray-400 hover:text-white transition-colors text-sm">
                  Reglamento
                </Link>
              </li>
              <li>
          ...
          <div>
            <h3 className="text-lg font-medium mb-4">Redes</h3>
            <div className="flex gap-4">
              <a
                href="https://www.instagram.com/asociaciondepilotosvallistosvf/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors p-2 rounded-lg hover:bg-gray-800"
                aria-label="Instagram Asociación de Pilotos Vallistos"
              >
              ...
              <a
                href="https://www.facebook.com/apivavallefertil2017?locale=es_LA"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-white transition-colors p-2 rounded-lg hover:bg-gray-800"
                aria-label="Facebook APIVA Valle Fértil"
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
